...
def call_llm(data, count):
    ...
    prompt2 = f"This is my knowledge array {data}. According to the learning from the knowledge array, give me the approximate price of the product and return only the price in numbers, if not found return 'Null'."
    ...
    prompt4 = f"This is my knowledge array {data}. According to the learning from the knowledge array, write the best possible description of the product in a minimum of 40 words and a maximum of 60 words. Return only the description."
